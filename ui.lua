...
local function CreateEPGPLogFrame()
    ...
    search_input:SetPoint("TOPLEFT", f, "TOPLEFT", 23, -17)
    search_input:SetPoint("TOPRIGHT", f, "TOPRIGHT", -117, -17)
    ...
    scrollParent:SetPoint("TOPLEFT", search_input, "BOTTOMLEFT", -6, 6)
    scrollParent:SetPoint("BOTTOMRIGHT", undo, "TOPRIGHT", 0, 0)
